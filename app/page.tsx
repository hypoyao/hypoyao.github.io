...
import GamePromptModal from "@/app/GamePromptModal";
      ...
      <section className="card homeCard homeNew">
        <header className="header">
          <div className="homeHeaderRow">
            <div className="homeBrand">
              <div className="homeBrandTitle">AI创意小游戏</div>
              <div className="homeBrandSub">把“对话”变成“作品”</div>
            </div>
        ...
        <section className="homeHeroGrid" aria-label="hero">
          <section className="heroPanel" aria-label="main call to action">
            <h1 className="heroTitle">用 AI 对话，把奇思妙想变成你的专属小游戏</h1>
            <p className="heroDesc">把想法说出来，看 AI 一步步帮你做成游戏。</p>
        ...
        <section className="homeSection" aria-label="all works">
          <div className="sectionHead">
            <h2 className="sectionTitle">优秀作品</h2>
            <div className="sectionSub">点开看看大家是怎么“说一句话就做出来”的。</div>
          </div>
